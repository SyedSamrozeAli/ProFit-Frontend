...
function MemberForm({ msg, profileImage, requestType, URL, member , setMember, btnText}) {
        ...
        <div className="flex-grow grid gap-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select name='gender' value={member.gender} onChange={handleInputChange} className="mt-1 p-2 w-full border rounded-md">
            ...
            <div>
              ...
              <select name='membership_type' value={member.membership_type} onChange={handleInputChange} className="mt-1 p-2 w-full border rounded-md">
            ...
            <div>
              ...
              <select name='membership_duration' value={member.membership_duration} onChange={handleInputChange} className="mt-1 p-2 w-full border rounded-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-600">Health Issues (if any)</label>
              <input type="text" 
              name='health_issues'
            ...
            <div>
              <label className="block text-sm font-medium text-gray-600">Trainer (if any)</label>
              <input 
              type="number" 
              name='trainer_id'
            ...
            <div>
              <label className="block text-sm font-medium text-gray-600">Height (ft)</label>
              <input 
              type="number" 
              name='height'
