          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                name="name"
                value={member.name}  // Ensure the value is updated correctly
            ...
            <div>
              ...
              <input
                type="email"
                name="member_email"
                value={member.member_email || ''}  // Ensure the value is updated correctly
                onChange={handleInputChange}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="date"
                name="DOB"
                value={member.DOB|| '' }  // Ensure the value is updated correctly
                onChange={handleInputChange}
                className="mt-1 p-2 w-full border rounded-md"
              />
            </div>
            <div>
              ...
              <input
                type="text"
                name="phone_number"
                value={member.phone_number|| ''}  // Ensure the value is updated correctly
                onChange={handleInputChange}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                name="CNIC"
                value={member.CNIC || '' }  // Ensure the value is updated correctly
                onChange={handleInputChange}
            ...
            <div>
              ...
              <select
                name="gender"
                value={member.gender|| ''}  // Ensure the value is updated correctly
                onChange={handleInputChange}
                className="mt-1 p-2 w-full border rounded-md"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="number"
                name="weight"
                value={member.weight|| ''}  // Ensure the value is updated correctly
                onChange={handleInputChange}
            ...
            <div>
              ...
              <input
                type="number"
                name="Height"
                value={member.height|| ''}  // Ensure the value is updated correctly
                onChange={handleInputChange}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                name="address"
                value={member.address|| ''}  // Ensure the value is updated correctly
                onChange={handleInputChange}
